					...
					<div class="span9">
						<div class="row">
							...
							<form action="https://test.bitpay.com/checkout" method="post" >
							  ...
							  <input type="hidden" name="data" value="mqnRbZb0/9YYMCwjhb90s1q1Vbh+BjRNBg2FHM69n4x76TpGUTSdsEk65eRJUK4hQYUtRpQOPXfkanFKz7vankR0xNuqYZS+NiEpALx1BuSBKWbVw4VJnVzCjEW73gfK" />
							  <input type="image" src="https://test.bitpay.com/img/button-medium.png" border="0" name="submit" alt="BitPay, the easy way to pay with bitcoins." >
								...
								<h4><strong id="cost1">Reduced Price: $17.84</strong></h4>
