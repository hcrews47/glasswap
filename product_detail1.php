...
<html lang="en">
    ...
    function parseJson(json) {
      ...
      document.getElementById("bit_cost").innerHTML = "Price in Bitcoin: " + (price/usdValue);
		...
		<!-- <script>
			var usd = document.getElementById("cost1").innerHTML;
			alert("hey");
			var xml = new XMLHttpRequest();
			var url ='https://api.coindesk.com/v1/bpi/currentprice/USD.json';
			var price = parseFloat(usd.substring(15));
			...
			document.getElementById("bit_cost").innerHTML = String(in_bit);
					...
					<div class="span9">
						<div class="row">
							...
							<form action="https://test.bitpay.com/checkout" method="post" >
							  <input type="hidden" name="action" value="checkout" onclcik="document.write('<?php
								include_once 'connection.php';
								$conn    = Connect();
								$User = "hcrews47";
							  $Email = "jhc6we@virginia.edu";
								$Item = 'Black Full Frames';
							  $Cost = 17.25;
							...
							<?php if(isset($_SESSION['logon'])){
								...
								<!-- <script>
								document.write("<h4><strong>Price in Bitcoin:");
								document.write(convert(document.getElementById("cost1").textContent)));
								document.write("</strong></h4>")
							</script> -->
							</div>
							<!-- /<script> document.write("<h1>5</h1>")</script> -->
							<!--
							<div class="span5">
