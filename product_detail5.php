...
<html lang="en">
    ...
    <body>
		...
		<div id="wrapper" class="container">
			...
			<p><a href="#"><img src="themes/images/ladies/5.png" alt="" /></a></p>
				<h2><span>Thin Wireframe Lenses</span></h2>
			</section>
				...
				<div class="row">
					<div class="span9">
						<div class="row">
							...
							<div class="span4">
								<a href="themes/images/ladies/1.png" class="thumbnail" data-fancybox-group="group1" title="Description 1"><img alt="" src="themes/images/ladies/1.jpg"></a>
							...
							<form action="https://test.bitpay.com/checkout" method="post" >
							  ...
							  $Email = "jhc6we@virginia.edu";
								$Item = 'Thin Wireframe Lenses';
							  $Cost = 22.30;
								$query   = "INSERT INTO transaction_history (user,email,item,cost) VALUES('$User','$Email','$Item','$Cost')";
							  $result = mysqli_query($conn,$query);
								?>');" />
							  <input type="hidden" name="posData" value="" />
							  <input type="hidden" name="data" value="mqnRbZb0/9YYMCwjhb90s1q1Vbh+BjRNBg2FHM69n4x76TpGUTSdsEk65eRJUK4hUQkdoJiwI8dN0a37O/jwea5PX4xNieYI29byth+ur6wIpgJNRZFgCaqqLEA+tc94agt/bKGGRxEhmXkezT2Q3cANLfUkCtCQEAikbZvX/Mg=" />
								<?php if(isset($_SESSION['logon'])){
									?>
								...
								<h4><strong id="cost1">Price: $22.30</strong></h4>
								...
								<fieldset>
									...
									<div class="actions"><input tabindex="9" class="btn btn-inverse medium" id="reg_btn" type="submit" value="Enter" formaction="product_detail5_discount.php">
									</div>
								</fieldset>
							</form>
							</div>
