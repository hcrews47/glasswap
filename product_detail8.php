...
<html lang="en">
    ...
    <body>
		...
		<div id="wrapper" class="container">
			...
			<p><a href="#"><img src="themes/images/ladies/8.png" alt="" /></a></p>
				<h2><span>Thin Circle Wireframes</span></h2>
			</section>
						...
						<div class="row">
							...
							<form action="https://test.bitpay.com/checkout" method="post" >
							  ...
							  $Email = "jhc6we@virginia.edu";
								$Item = 'Thin Circle Wireframes';
							  $Cost = 33.50;
								$query   = "INSERT INTO transaction_history (user,email,item,cost) VALUES('$User','$Email','$Item','$Cost')";
							  $result = mysqli_query($conn,$query);
								?>');" />
							  <input type="hidden" name="posData" value="" />
							  <input type="hidden" name="data" value="mqnRbZb0/9YYMCwjhb90s1q1Vbh+BjRNBg2FHM69n4x76TpGUTSdsEk65eRJUK4hUQkdoJiwI8dN0a37O/jwec4MVTyv3Qme6ztf7Lc5FCbe1gR2FLMzzQC33SpTgaKlxzKrBhd2oUmj7HwsHugWKI1Gmm/w9XLDTKU0tHVmWIw=" />
								<?php if(isset($_SESSION['logon'])){
									?>
								...
								<fieldset>
									...
									<div class="actions"><input tabindex="9" class="btn btn-inverse medium" id="reg_btn" type="submit" value="Enter" formaction="product_detail8_discount.php">
									</div>
								</fieldset>
							</form>
							</div>
