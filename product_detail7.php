						...
						<div class="row">
							...
							<form action="https://test.bitpay.com/checkout" method="post" >
							  ...
							  $Email = "jhc6we@virginia.edu";
								$Item = 'Black Floral Frames';
							  $Cost = 10.45;
								$query   = "INSERT INTO transaction_history (user,email,item,cost) VALUES('$User','$Email','$Item','$Cost')";
							  $result = mysqli_query($conn,$query);
								?>');" />
							  <input type="hidden" name="posData" value="" />
							  <input type="hidden" name="data" value="mqnRbZb0/9YYMCwjhb90s1q1Vbh+BjRNBg2FHM69n4x76TpGUTSdsEk65eRJUK4hUQkdoJiwI8dN0a37O/jweSQ3KL2+m2K5NBOcpa1V85YfJMhlu7r5GEKVtbFFA+MQHXOuYKvwOQOIvVmNbTXZLTCH9LTxFqYddpVP4FDSnPc=" />
								<?php if(isset($_SESSION['logon'])){
									?>
